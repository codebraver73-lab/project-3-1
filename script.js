...
/*Carousel*/
  const carousel = document.querySelector('#equipmentCarousel');
  ...
  /* Equipment-section*/
  document.getElementById("equipement-button1").addEventListener("click",function(){
    window.location.href="http://127.0.0.1:5500/mobility.html";
  });

  document.getElementById("equipement-button3").addEventListener("click",function(){
    window.location.href="http://127.0.0.1:5500/care.html";
  });

  document.getElementById("equipement-button2").addEventListener("click",function(){
    window.location.href="http://127.0.0.1:5500/respiratory.html";
  });

  document.getElementById("equipement-button4").addEventListener("click",function(){
    window.location.href="http://127.0.0.1:5500/disposables.html";
  });
